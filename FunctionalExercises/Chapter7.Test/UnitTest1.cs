...
namespace Tests
{
    ...
    {
        public static  Func<T, T> ApplyR<T>(this Func<T, T , T> f, T t)
        {
            return x => f(x, t);
        }
    }
    ...
    public class Tests
    {
        ...
        //public int Remainder(int number, int divisor) => number % divisor;
        ...
        {
            var result = Remainder.ApplyR(5);
            Assert.AreEqual(4, result(24));
